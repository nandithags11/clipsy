...
# SECRET_KEY = 'django-insecure-nh*lr9xy6500gwm%$y*2&!!e#d)gz!&gv^5dhw^8fw=k7rbv1*'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'videostream_db'),
        'USER': os.environ.get('DB_USER', 'videostream_user'),
